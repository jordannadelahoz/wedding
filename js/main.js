  ...
  $(document).ready(function() {
    ...
    $('input[name="attend"]').click(function() {
      if ($("#yes").is(":checked")) {
        ...
        $("#message")
          .val("")
          .attr("placeholder", "Regrets");
        $('input[name="guest"]').prop("checked", false);
        $(
          '#rsvp_guest_info input[type="text"], #rsvp_guest_info input[type="email"], #rsvp_song input[type="text"]'
        ).val("");
      }
    });
    ...
    $(function() {
      ...
      $(form).submit(function(e) {
        ...
        if (!$.trim($("#rsvp_form input[name=name]").val())) {
        ...
        if (
          !$.trim($("#rsvp_form input[name=email]").val()) &&
          attending == "yes"
        ) {
          //if this field is empty
